...

{
	...
	System.out.println("Initial value of Non-static variable:"+v1.num);
	v1.num =90;
	
	System.out.println("Value changed to 90 using v1");
	
	System.out.println("Call using v1 object after update: "+ v1.num);
   ...
   System.out.println();
   System.out.println("***********Static Varaible************");
   System.out.println();
    

   System.out.println("Initial value of static variable:"+v1.num2);
   v1.num2= 60;
   ...
   System.out.println("Call using v2 object: "+ v3.num2);
